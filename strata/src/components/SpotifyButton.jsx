...
export default function SpotifyButton({ artist, title }) {
  ...
  return (
    <a
      ...
      className="relative z-10 flex h-7 w-7 flex-shrink-0 items-center justify-center rounded
                 text-ink-muted transition-colors hover:bg-sunken hover:text-spotify"
    >
